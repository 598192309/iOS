...
#import "UIColor+LqExtension.h"


@implementation UIColor (LqExtension)

//默认alpha值为1
+ (UIColor *)lq_colorWithHexString:(NSString *)color
{
    return [self lq_colorWithHexString:color alpha:1.0f];
}
...
{
    return [UIColor lq_colorWithHex:hexValue alpha:1.0];
}
